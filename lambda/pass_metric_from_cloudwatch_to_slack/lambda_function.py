...
def lambda_handler(event, context):
    ...
    if new_state.find("ALARM") >= 0:
        title = ":rotating_light: Alert Occurs:  " + alarm_name
        color = "#eb3468"
    else:
        title = alarm_name + " is OK now"
        color = "#1fed31" 
                ...
                "blocks":[                    
                    {
                        ...
                        "fields": [
                            {
                                "type": "mrkdwn",
                                "text": "previous status: " + old_state
                            },
                            {
                                "type": "mrkdwn",
                                "text": "current status: " + new_state
                            },
                            {
                                "type": "mrkdwn",
                                "text": "time: " + change_time
                            }
                        ]
                    }
